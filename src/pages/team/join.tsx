        ...
        <>
            <Layout >
                ...
                <div className="flex flex-grow justify-center items-center">
                    <div className="lg:md:w-2/4 w-3/4 h-1/4 flex flex-col justify-between  rounded-lg">
                        ...
                        <button onClick={() => { handleSubmit() }} className="bg-blue-500 text-white px-4 py-2 rounded-lg mt-4 w-24 self-end">Join</button>
                    </div>
                </div>
            </Layout>
        </>
