...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center w-12 h-screen pb-8 pt-4 bg-white dark:border-gray-700">
        <nav className="flex flex-col items-center flex-1 space-y-3 ">
            ...
            <Link href="/go" className="p-1.5 inline-block dark:text-gray-500  focus:outline-nones transition-colors duration-200 rounded-lg  hover:bg-gray-100 ">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 0 1-.923 1.785A5.969 5.969 0 0 0 6 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337Z" />
            ...
            <a href="#" className="p-1.5 inline-block dark:text-gray-500 text-blue-500 transition-colors duration-200 bg-blue-100 rounded-lg  dark:bg-gray-100 hover:bg-gray-100">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
            ...
            <a href="#" className="p-1.5 inline-block dark:text-gray-500  focus:outline-nones transition-colors duration-200 rounded-lg  hover:bg-gray-100">
            <svg style={{width :19,height : 19}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9.75 16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />
            ...
            <a href="#" className="p-1.5 inline-block dark:text-gray-500 focus:outline-nones transition-colors duration-200 rounded-lg  hover:bg-gray-100 active:bg-gray-100 focus:bg-gray-100 ">
                <svg style={{width :19,height : 19}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
    ...
    <div className="h-screen px-3 pb-8 pt-4 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:border-gray-700">
