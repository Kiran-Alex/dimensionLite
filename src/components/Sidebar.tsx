            ...
            <aside className="flex w-fit">
                ...
                <div className="flex flex-col items-center w-12 h-screen pb-8 pt-4 bg-white dark:border-gray-700">
                    <nav className="flex flex-col items-center flex-1 space-y-3 ">
                        ...
                        <Link href="/chat" onClick={() => { setNavState("chat"),handleOpen()  }} className={`p-1.5 inline-block dark:text-gray-500  focus:outline-nones transition-colors duration-200 rounded-lg  hover:bg-gray-100 active:bg-blue-100 focus:bg-blue-100 ${NavState.startsWith("chat") && "bg-gray-200 text-blue-400" } `}>
                        ...
                        <Link href="/team"  onClick={() => { setNavState("team"),handleOpen()  }} className={`p-1.5 inline-block dark:text-gray-500 transition-colors duration-200  rounded-lg   hover:bg-gray-100 active:bg-blue-100 focus:bg-blue-100 ${NavState.startsWith("team") && "bg-gray-200 text-blue-400" } `}>
                        ...
                        <Link onClick={() => setIsOpen(false)} href="/deployments" className={`p-1.5 inline-block dark:text-gray-500  focus:outline-nones transition-colors duration-200 rounded-lg  hover:bg-gray-100 active:bg-blue-100 focus:bg-blue-100 ${NavState.startsWith("deployments") && "bg-gray-200  text-blue-400" } `}>
                            <svg style={{ width: 19, height: 19 }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <Link href="/settings" onClick={() => { setNavState("settings"),handleOpen()  }} className={`p-1.5 inline-block dark:text-gray-500 focus:outline-nones transition-colors duration-200 rounded-lg  hover:bg-gray-100 active:bg-blue-100 focus:bg-blue-100 ${NavState.startsWith("settings") && "bg-gray-200  text-blue-400"} `}>
                            <svg style={{ width: 19, height: 19 }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
