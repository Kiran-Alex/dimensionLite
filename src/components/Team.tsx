    ...
    return (
        <>
            <div className="space-y-1 px-1">
                ...
                <Link className="flex items-center px-2 py-1  text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-500 hover:bg-gray-100  hover:text-gray-700" href="/team/create">
                ...
                <Link className="flex items-center px-2 py-1  text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-500 hover:bg-gray-100  hover:text-gray-700" href="/team/join">
