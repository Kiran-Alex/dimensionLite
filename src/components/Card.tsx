...
const Card:React.FC<cardProps> = ({image,title,connected,loading}) => {
  return ( 
  <>
  <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl lg:md:w-96 w-full hover:bg-gray-100 cursor-pointer">
