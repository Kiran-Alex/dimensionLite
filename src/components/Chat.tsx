    ...
    return (
        <>
            <div className="space-y-1 px-1">
                ...
                <p className="px-2 text-sm w-5/5 flex flex-row justify-between cursor-pointer"><span className="flex flex-row justify-center items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-3 h-3">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
                    &nbsp;&nbsp;&nbsp;<span className="text-gray-600 text-xs">TEAM</span> </span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-3 h-3">
